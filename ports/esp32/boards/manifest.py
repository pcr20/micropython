...
include("$(PORT_DIR)/custom_modules_for_freezing/lib/bluetooth/aioble/manifest.py")freeze("$(PORT_DIR)/custom_modules_for_freezing", ("evo_gateway/__init__.py", "evo_gateway/app.py", "evo_gateway/app_helper.py","evo_gateway/config.py","evo_gateway/general.py","evo_gateway/globalcfg.py","evo_gateway/mqtt.py"))
